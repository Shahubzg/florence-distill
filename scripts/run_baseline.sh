#!/bin/bash
# run_baseline.sh
# Run teacher_baseline.py with caption + bbox/class prompts (thesis-aligned).
...
INSTANCES_JSON="/leonardo_work/IscrC_DEMOLLM/florence_distill/data/coco/annotations/instances_val2017.json"
